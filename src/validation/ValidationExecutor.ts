                ...
                if (!metadata.each || !(Array.isArray(value) || value instanceof Set || value instanceof Map)) {
                    const validatedValue =
                        typeof metadata.target === 'string'
                            ? customConstraintMetadata.target(value, validationArguments)
                            : customConstraintMetadata.instance.validate && customConstraintMetadata.instance.validate(value, validationArguments);
